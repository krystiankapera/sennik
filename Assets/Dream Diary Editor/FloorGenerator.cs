...
public class FloorGenerator : EditorWindow {
    ...
    void GeneratePortals() {
        for (int i = 0; i < portalsCount; i++) {
            // TODO make sure to retry when portal is impossible to create
            GeneratePortal();
        }
    }

    void GenerateRandomWalls() {
        // TODO make sure to retry when wall is impossible to create
    ...
    void GenerateObstacles() {
        for (int i = 0; i < obstaclesCount; i++) {
            // TODOmake sure to retry when obstacle is impossible to create
            GenerateRandomObstacle();
        }
    }

    // TODO change to real portal
    void GeneratePortal() {
    ...
    void GenerateRandomWall() {
        ...
        if (vertical) {
            ...
            // TODO fix the situation when there is no ranges
